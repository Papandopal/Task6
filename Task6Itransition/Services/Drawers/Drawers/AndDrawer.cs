...
{
    public class AndDrawer : IDrawer, ICircuitDrawer
    {
        ...
        void IDrawer.MouseClick(MouseClickModel model)
        {
            ...
            finalItem = new CircuitItem
            {
                ...
                Figures = ((ICircuitDrawer)this).GetBasedCircuit(new SKPoint(model.X, model.Y), 40, 2, 1, 10, 16, CircuitItemType.And, out inputs, out outputs),
                Paints = ((ICircuitDrawer)this).GetBasedCircuitPaint(),
                Type = CircuitItemType.And,
